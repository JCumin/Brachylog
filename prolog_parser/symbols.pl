...
token_predicate('@c', 'brachylog_string_to_codes').
token_predicate('@d', '').
...
token_predicate('@q', '').
token_predicate('@r', '').
token_predicate('@s', 'brachylog_string_substring').
token_predicate('@t', '').
...
token_variable('#':'A', 'ConstraintA').
token_variable('#':'B', 'ConstraintB').
token_variable('#':'C', 'ConstraintC').
token_variable('#':'D', 'ConstraintD').
token_variable('#':'E', 'ConstraintE').
token_variable('#':'F', 'ConstraintF').
token_variable('#':'G', 'ConstraintG').
token_variable('#':'H', 'ConstraintH').
token_variable('#':'I', 'ConstraintI').
token_variable('#':'J', 'ConstraintJ').
token_variable('#':'K', 'ConstraintK').
token_variable('#':'L', 'ConstraintL').
token_variable('#':'M', 'ConstraintM').
token_variable('#':'N', 'ConstraintN').
token_variable('#':'O', 'ConstraintO').
token_variable('#':'P', 'ConstraintP').
token_variable('#':'Q', 'ConstraintQ').
token_variable('#':'R', 'ConstraintR').
token_variable('#':'S', 'ConstraintS').
token_variable('#':'T', 'ConstraintT').
token_variable('#':'U', 'ConstraintU').
token_variable('#':'V', 'ConstraintV').
token_variable('#':'W', 'ConstraintW').
token_variable('#':'X', 'ConstraintX').
token_variable('#':'Y', 'ConstraintY').
token_variable('#':'Z', 'ConstraintZ').
