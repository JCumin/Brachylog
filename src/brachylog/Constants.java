...
public abstract class Constants {
	...
	public static final String P_EQUAL					= "brachylog_call_equal";
	...
	public static final String PM_ARCCOS				= "brachylog_math_cosinus";
	public static final String PM_ARCSIN				= "brachylog_math_sinus";
	public static final String PM_ARCTAN				= "brachylog_math_tan";
	public static final String PM_COSH					= "brachylog_math_cosinus";
	public static final String PM_SINH					= "brachylog_math_sinus";
	public static final String PM_TANH					= "brachylog_math_tan";
	public static final String PM_ARCCOSH				= "brachylog_math_cosinus";
	public static final String PM_ARCSINH				= "brachylog_math_sinus";
